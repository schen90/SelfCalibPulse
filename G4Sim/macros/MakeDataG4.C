...
void MakeDataG4(string G4inputfile, string outputfile){
...
int main(int argc, char *argv[]){
  ...
  if(argc>2){
    MakeDataG4( string(argv[1]), string(argv[2]) );
  }else if(argc>1){
    MakeDataG4( string(argv[1]), "rootfiles/G4SimData0000.root" );
  }else{
    MakeDataG4( "trunk/GammaEvents.0000", "rootfiles/G4SimData0000.root" );
  }
