...
//#define SINGLEHIT
#define PSCEMIN 300. // keV, PSC greate with PS Energy > PSCEMIN
...
struct PS{
  ...
  float apulse[NCHAN][BSIZE]; // pulse shape with original amplitude
  float opulse[NCHAN][BSIZE]; // original pulse shape (normalized)
};
